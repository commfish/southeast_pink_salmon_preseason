# run code 7_summarize_models_basic_by_odd_even.R first
# inputs
fit_value_model<-23.106 #best model outputs (bias-corrected); value of forecast (from model_summary_table2)
lwr_pi_80<-14.182 # 80% PI from model_summary_table2 in the results folder
upr_pi_80<-37.646 # 80% PI from model_summary_table2 in the results folder
best_model<-m2c
model<-'m2c'
