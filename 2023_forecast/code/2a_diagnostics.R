...
# inputs
fit_value_model<-19.162 #best model outputs (bias-corrected); value of forecast from table 3
lwr_pi_80<-12.87 # 80% PI from table 3
upr_pi_80<-28.532 # 80% PI from table 3
best_model<-m2
model<-'m2'
