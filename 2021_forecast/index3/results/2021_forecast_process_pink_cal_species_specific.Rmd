...
subtitle: "pink_cal_species_specific"
...
index <- "index3" #change based on index
...
Based on an additive model with CPUE and temperature, the SEAK pink salmon harvest in 2021 is predicted to be in the strong range with a point estimate of 30.7 million fish (80% prediction interval: 20.9 to 45.2 million fish).
