---
title: "2021 Preseason Pink Salmon Forecast--version2"
...
Based on an additive model with CPUE and temperature, the SEAK pink salmon harvest in 2021 is predicted to be in the strong range with a point estimate of 29.7 million fish (80% prediction interval: 19.8 to 44.4 million fish).
...
#Conclusion 
The SEAK pink salmon harvest in 2021 is predicted to be in the strong range with a point estimate of 29.7 million fish (80% prediction interval: 19.8 to 44.4 million fish).

```{r pred, echo=FALSE}
knitr::include_graphics(here("2021_forecast/results/figs/catch_plot_pred.png"))
```

Figure 5: SEAK harvest (millions) a) by year and b) by the fitted values from model m2. The line in figure b is a one to one line. The predicted 2021 forecast is symbolized as a grey circle with an 80% prediction interval (19.8 to 44.4 million fish) in figure a. 
