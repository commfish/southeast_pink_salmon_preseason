...
In addition to these environmental variables, it would be beneficial to add additional performance metrics to rank the models (e.g., number of years the model performed the best; number of leverage point years (run the the two competing models without the leverage years and review the performance metrics)).
