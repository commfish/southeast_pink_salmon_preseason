...
Figure 3: SEAK harvest (millions) a) by year with the fitted values from model 2  shown as a line in the figure, and b) by the fitted values with the predicted 2020 forecast symbolized as a star with 80% bootstrap confidence intervals. 
