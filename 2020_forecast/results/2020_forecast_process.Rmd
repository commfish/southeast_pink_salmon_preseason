...
# Executive Summary
Forecasts were developed using an approach described in Murphy et al. inpress. A linear multiple regression model was developed using monthly peak juvenile CPUE (standardized catch based on 20 minute trawl set) for the June and July surveys and associated environmental parameters. The model used was:
