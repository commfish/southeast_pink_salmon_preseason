...
Figure 1: a) Standardized residuals versus juvnile year and b) residuals (millions) versus fitted values for model 2. Positive residuals indicate that the observed harvest was larger than predicted by the model.
...
#Conclusion 
The SEAK pink salmon harvest in 2020 is predicted to be in the weak range with a point estimate of 2 million fish (80% confidence interval: 0–20 million fish; Figure 3). 
