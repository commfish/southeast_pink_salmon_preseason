...
# inputs
fit_value_model<-18.0 #best model outputs (bias-corrected); value of forecast (from model_summary_table2)
lwr_pi_80<-9.6 # 80% PI from model_summary_table2 in the results folder
upr_pi_80<-33.7 # 80% PI from model_summary_table2 in the results folder
best_model<-m7
model<-'m7'
