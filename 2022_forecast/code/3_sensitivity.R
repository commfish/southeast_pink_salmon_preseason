...
model.names.sensitivity <- c(m1s='CPUE',
                             ...
                             m8s='CPUE + ISTI15_MJJ',
                             m9s='CPUE + ISTI20_MJJ',
                             m10s='CPUE + Chatham_SST_May',
                             m11s='CPUE + Chatham_SST_MJJ',
                             m12s='CPUE + Chatham_SST_AMJ',
                             m13s='CPUE + Chatham_SST_AMJJ',
                             m14s='CPUE + Icy_Strait_SST_May',
                             m15s='CPUE + Icy_Strait_SST_MJJ',
                             m16s='CPUE + Icy_Strait_SST_AMJ',
                             m17s='CPUE + Icy_Strait_SST_AMJJ',
                             m18s='CPUE + NSEAK_SST_May',
                             m19s='CPUE + NSEAK_SST_MJJ',
                             m20s='CPUE + NSEAK_SST_AMJ',
                             m21s='CPUE + NSEAK_SST_AMJJ',
                             m22s='CPUE + SEAK_SST_May',
                             m23s='CPUE + SEAK_SST_MJJ',
                             m24s='CPUE + SEAK_SST_AMJ',
                             m25s='CPUE + SEAK_SST_AMJJ')
...
lm(SEAKCatch_log ~ CPUE + ISTI3_May, data = log_data_subset) -> m2s
lm(SEAKCatch_log ~ CPUE + ISTI10_May, data = log_data_subset) -> m3s
lm(SEAKCatch_log ~ CPUE + ISTI15_May, data = log_data_subset) -> m4s
lm(SEAKCatch_log ~ CPUE + ISTI20_May, data = log_data_subset) -> m5s
lm(SEAKCatch_log ~ CPUE + ISTI3_MJJ, data = log_data_subset) -> m6s
lm(SEAKCatch_log ~ CPUE + ISTI10_MJJ, data = log_data_subset) -> m7s
lm(SEAKCatch_log ~ CPUE + ISTI15_MJJ, data = log_data_subset) -> m8s
lm(SEAKCatch_log ~ CPUE + ISTI20_MJJ, data = log_data_subset) -> m9s
lm(SEAKCatch_log ~ CPUE + Chatham_SST_May, data = log_data_subset) -> m10s
lm(SEAKCatch_log ~ CPUE + Chatham_SST_MJJ, data = log_data_subset) -> m11s
lm(SEAKCatch_log ~ CPUE + Chatham_SST_AMJ, data = log_data_subset) -> m12s
lm(SEAKCatch_log ~ CPUE + Chatham_SST_AMJJ, data = log_data_subset) -> m13s
lm(SEAKCatch_log ~ CPUE + Icy_Strait_SST_May, data = log_data_subset) -> m14s
lm(SEAKCatch_log ~ CPUE + Icy_Strait_SST_MJJ, data = log_data_subset) -> m15s
lm(SEAKCatch_log ~ CPUE + Icy_Strait_SST_AMJ, data = log_data_subset) -> m16s
lm(SEAKCatch_log ~ CPUE + Icy_Strait_SST_AMJJ, data = log_data_subset) -> m17s
lm(SEAKCatch_log ~ CPUE + NSEAK_SST_May, data = log_data_subset) -> m18s
lm(SEAKCatch_log ~ CPUE + NSEAK_SST_MJJ, data = log_data_subset) -> m19s
lm(SEAKCatch_log ~ CPUE + NSEAK_SST_AMJ, data = log_data_subset) -> m20s
lm(SEAKCatch_log ~ CPUE + NSEAK_SST_AMJJ, data = log_data_subset) -> m21s
lm(SEAKCatch_log ~ CPUE + SEAK_SST_May, data = log_data_subset) -> m22s
lm(SEAKCatch_log ~ CPUE + SEAK_SST_MJJ, data = log_data_subset) -> m23s
lm(SEAKCatch_log ~ CPUE + SEAK_SST_AMJ, data = log_data_subset) -> m24s
lm(SEAKCatch_log ~ CPUE + SEAK_SST_AMJJ, data = log_data_subset) -> m25s
...
results %>% 
  ...
  mutate(model = c('m1s','m2s','m3s','m4s','m5s','m6s','m7s','m8s',
                   ...
                   'm18s','m19s','m20s','m21s','m22s','m23s','m24s','m25s')) %>%
